...
function pc_localize_frontend_configuration(){
    ...
    $frontend_configuration = get_transient('pc_frontend_configuration_' . $product_id);

    if ($frontend_configuration == false || $frontend_configuration == null || $frontend_configuration == []){
        ...
        set_transient('pc_frontend_configuration_' . $product_id, $frontend_configuration, 60 * 60 * 24 * 7);
    }
